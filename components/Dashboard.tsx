...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar bg-[#050505] relative">
      ...
      <div className="p-8 max-w-[1800px] mx-auto space-y-10">
        ...
        <div className="flex items-end justify-between pb-6 border-b border-white/5">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-white mb-1.5">Command Center</h1>
          ...
          <div className="flex gap-3">
             <button className="h-10 px-4 bg-[#1c1c1e] hover:bg-[#2c2c2e] border border-white/10 rounded-xl text-zinc-300 text-xs font-semibold transition-all flex items-center">
                <Activity className="w-3.5 h-3.5 mr-2 text-zinc-500" />
                System Logs
             </button>
             <button className="h-10 px-5 bg-white hover:bg-zinc-200 text-black rounded-xl text-xs font-bold shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
           {/* Metrics */}
           <div className="relative group p-6 rounded-2xl bg-zinc-900/40 border border-white/5 hover:border-emerald-500/30 transition-colors overflow-hidden">
           ...
           <div className="relative group p-6 rounded-2xl bg-zinc-900/40 border border-white/5 hover:border-blue-500/30 transition-colors overflow-hidden">
           ...
           <div className="relative group p-6 rounded-2xl bg-zinc-900/40 border border-white/5 hover:border-amber-500/30 transition-colors overflow-hidden">
           ...
           <div className="relative group p-6 rounded-2xl bg-zinc-900/40 border border-white/5 hover:border-red-500/30 transition-colors overflow-hidden">
                ...
                <div className="flex bg-zinc-900/50 p-1 rounded-lg border border-white/5">
                    <button
                      ...
                      className={`px-3 py-1 text-[10px] font-bold rounded ${
                        repoFilter === 'all' ? 'text-white bg-white/10 shadow-sm' : 'text-zinc-500 hover:text-zinc-300'
                      }`}
                    >
                      All
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 text-[10px] font-bold rounded ${
                        repoFilter === 'prod' ? 'text-white bg-white/10 shadow-sm' : 'text-zinc-500 hover:text-zinc-300'
                      }`}
                    >
                      Prod
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 text-[10px] font-bold rounded ${
                        repoFilter === 'dev' ? 'text-white bg-white/10 shadow-sm' : 'text-zinc-500 hover:text-zinc-300'
                      }`}
                    >
                      Dev
                    </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
               {visibleProjects.slice(0, visibleRepoCount).map((project) => {
                ...
                <div 
                  ...
                  className={`bg-[#1c1c1e]/50 backdrop-blur-sm rounded-2xl p-6 flex flex-col justify-between h-[280px] hover:-translate-y-1 transition-all duration-300 ease-out cursor-pointer border group relative overflow-hidden shadow-lg ${
                      selectedRepoIds.includes(project.id) ? 'border-pink-500/50 ring-1 ring-pink-500/50' : 'border-white/5 hover:border-white/10'
                  }`}
                >
                    {/* Status Glow */}
                    ...
                    {/* Checkbox */}
                    <div className={`absolute top-4 right-4 w-5 h-5 rounded border flex items-center justify-center transition-colors z-20 ${
                        selectedRepoIds.includes(project.id) ? 'bg-pink-500 border-pink-500' : 'border-zinc-600 hover:border-zinc-400 bg-transparent'
                    }`}>
                    ...
                    <div>
                       ...
                       <p className="text-xs text-zinc-400 leading-relaxed line-clamp-2 font-medium">{project.description}</p>
                    </div>
                        ...
                        {issues.slice(0, 3).map(issue => (
                            <tr key={issue.id} className="group hover:bg-white/[0.02] transition-colors">
                                ...
                                <td className="p-4">
                                    ...
                                    issue.severity === 'critical' ? 'bg-red-500 text-white shadow-[0_0_10px_rgba(239,68,68,0.4)]' : 
